...
local function get_highlight_definitions(mode)
	...
	hl.common = {
		...
		Search = { fg = p.string },
		SpecialKey = { fg = p.string },
		SpellCap = { fg = p.string },
		SpellLocal = { fg = p.string },
		SpellBad = { fg = p.string },
		SpellRare = { fg = p.string },
		StatusLine = { fg = p.string },
		StatusLineNC = { fg = p.string },
		WildMenu = { fg = p.string },
		TabLine = { fg = p.string },
